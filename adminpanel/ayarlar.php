...
if($_POST){
            ...
            $ekle = mysql_query("UPDATE `ayarlar` SET `ayar_isim` = '$ayar_isim', `ayar_merhabayazisi` = '$ayar_merhabayazisi', `ayar_acikalama` = '$ayar_acikalama', `ayar_title` = 'ayar_title', `ayar_keywords` = '$ayar_keywords', `ayar_description` = '$ayar_description', `ayar_facebook` = '$ayar_facebook', `ayar_twitter` = '$ayar_twitter', `ayar_linkedin` = '$ayar_linkedin', `ayar_instagram` = '$ayar_instagram', `ayar_facikalama` = '$ayar_facikalama', `ayar_flokasyon` = '$ayar_flokasyon', `ayar_fimail` = '$ayar_fimail', `ayar_author` = '$ayar_author' WHERE `ayarlar`.`ayar_id` = 1 ");
